...
_Class.new = function(scene)
  ...
  function UI:setVars()
        ...
        self:_vars("image",  const.title_image_, false)
  ...
  function UI:create()
   self:_create("common",  const.page_common, false)
    ...
    self:setLanguge()
        ...
        self:_create("image",  const.title_image_, false)
  ...
  function UI:didShow(params)
    self:_didShow("common",  const.page_common, false)
        ...
        self:_didShow("image",  const.title_image_, false)
  ...
  function UI:didHide(params)
    self:_didHide("common",  const.page_common, false)
        ...
        self:_didHide("image",  const.title_image_, false)
  ...
  function UI:destroy(params)
    self:_destroy("common",  const.page_common)
        ...
        self:_destroy("image",  const.title_image_, false)
  ...
  function UI:resume(params)
        ...
        self:_resume("image",  const.title_image_, false)
