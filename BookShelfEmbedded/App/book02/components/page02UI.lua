...
_Class.new = function(scene)
  ...
  function UI:setVars()
        ...
        self:_vars("dynamictext",  const.Text1_dynamictext_, false)
  ...
  function UI:create()
   self:_create("common",  const.page_common, false)
    ...
    self:setLanguge()
        ...
        self:_create("dynamictext",  const.Text1_dynamictext_, false)
  ...
  function UI:didShow(params)
    self:_didShow("common",  const.page_common, false)
        ...
        self:_didShow("dynamictext",  const.Text1_dynamictext_, false)
  ...
  function UI:didHide(params)
    self:_didHide("common",  const.page_common, false)
        ...
        self:_didHide("dynamictext",  const.Text1_dynamictext_, false)
  ...
  function UI:destroy(params)
    self:_destroy("common",  const.page_common)
        ...
        self:_destroy("dynamictext",  const.Text1_dynamictext_, false)
  ...
  function UI:resume(params)
        ...
        self:_resume("dynamictext",  const.Text1_dynamictext_, false)
