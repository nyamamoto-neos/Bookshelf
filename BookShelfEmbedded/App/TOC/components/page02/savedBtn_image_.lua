...
-- not
local imageWidth             = 95/4
local imageHeight            = 29/4
local mX, mY                 = _K.ultimatePosition(1030, 864)
local oriAlpha = 1
--
local imagePath = "p2/savedbtn.png"
--
...
function _M:localPos(UI)
  ...
  local layer       = UI.layer
    ...
    layer.savedBtn = display.newImageRect( _K.imgDir..imagePath, _K.systemDir, imageWidth, imageHeight)
    -- layer.savedBtn = newImageRect(savedbtn, imageWidth, imageHeight )
    if layer.savedBtn == nil then return end
