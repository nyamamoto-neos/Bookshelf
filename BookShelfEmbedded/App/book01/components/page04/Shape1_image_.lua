...
-- not
local imageWidth             = 587/4
local imageHeight            = 576/4
local mX, mY                 = _K.ultimatePosition(961, 658)
local oriAlpha = 1
--
local imagePath = "p4/shape1.png"
--
...
local sheet    = graphics.newImageSheet ( _K.spriteDir.."page4.png", _K.systemDir, info:getSheet() )
